...
namespace LabasanCryptoFountain.Controllers
{
    public class AccountsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,TotalSentSecond,TotalSentMinute,TotalSentHour,TotalSentDay,TotalSentWeek,TotalSentMonth,TotalSentYear")] Account account)
        {
            if (id != account.ID)
            {
                return NotFound();
